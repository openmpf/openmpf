...
#ifndef MPF_AUDIO_DETECTION_COMPONENT_ADAPTER_H_
#define MPF_AUDIO_DETECTION_COMPONENT_ADAPTER_H_
...
namespace MPF {
    namespace COMPONENT {
        ...
        class MPFAudioDetectionComponentAdapter : public MPFDetectionComponent {
        public:
            virtual ~MPFAudioDetectionComponentAdapter() { }
        ...
        protected:
            MPFAudioDetectionComponentAdapter() = default;
        };

    } // namespace COMPONENT
} // namespace MPF

#endif  // MPF_AUDIO_DETECTION_COMPONENT_ADAPTER_H_
