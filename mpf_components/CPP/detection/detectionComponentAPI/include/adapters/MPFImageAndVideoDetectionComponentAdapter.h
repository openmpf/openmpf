...
#ifndef MPF_IMAGE_AND_VIDEO_DETECTION_COMPONENT_ADAPTER_H_
#define MPF_IMAGE_AND_VIDEO_DETECTION_COMPONENT_ADAPTER_H_
...
namespace MPF {
    namespace COMPONENT {
        ...
        public:
            virtual ~MPFImageAndVideoDetectionComponentAdapter() { }
...
#endif  // MPF_IMAGE_AND_VIDEO_DETECTION_COMPONENT_ADAPTER_H_
