...
#ifndef MPF_IMAGE_DETECTION_COMPONENT_ADAPTER_H_
#define MPF_IMAGE_DETECTION_COMPONENT_ADAPTER_H_
...
namespace MPF {
    namespace COMPONENT {
        ...
        public:
            virtual ~MPFImageDetectionComponentAdapter() { }
...
#endif  // MPF_IMAGE_DETECTION_COMPONENT_ADAPTER_H_
