...
#ifndef MPF_CPP_COMPONENTS_FRAMECROPPER_H
#define MPF_CPP_COMPONENTS_FRAMECROPPER_H
...
namespace MPF { namespace COMPONENT {
    ...
    protected:
        ...
        void AddDetectionProperties(MPFImageLocation &imageLocation) override;
...
#endif //MPF_CPP_COMPONENTS_FRAMECROPPER_H
