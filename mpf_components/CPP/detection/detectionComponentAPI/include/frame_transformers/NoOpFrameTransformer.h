...
#ifndef MPF_CPP_COMPONENTS_NOOPFRAMETRANSFORMER_H
#define MPF_CPP_COMPONENTS_NOOPFRAMETRANSFORMER_H
...
namespace MPF { namespace COMPONENT {
    ...
    public:
        NoOpFrameTransformer(const cv::Size &frameSize);
...
#endif //MPF_CPP_COMPONENTS_NOOPFRAMETRANSFORMER_H
