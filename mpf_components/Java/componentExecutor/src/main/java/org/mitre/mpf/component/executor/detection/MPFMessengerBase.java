...
public abstract class MPFMessengerBase implements MessageListener {
    ...
    protected static MPFDetectionComponentBase detector;
    
    public MPFMessengerBase(MPFDetectionComponentBase detector, final String msgQueueName) throws JMSException {
