...
PYBIND11_MODULE(mpf_cpp_sdk, m) {
    ...
    py::enum_<MPFDetectionError>(m, "DetectionError")
            ...
            .value("UNRECOGNIZED_DATA_TYPE", MPFDetectionError::MPF_UNRECOGNIZED_DATA_TYPE)
            .value("UNSUPPORTED_DATA_TYPE", MPFDetectionError::MPF_UNSUPPORTED_DATA_TYPE)
            .value("INVALID_DATAFILE_URI", MPFDetectionError::MPF_INVALID_DATAFILE_URI)
            ...
            .value("IMAGE_READ_ERROR", MPFDetectionError::MPF_IMAGE_READ_ERROR)
            .value("BAD_FRAME_SIZE", MPFDetectionError::MPF_BAD_FRAME_SIZE)
            .value("BOUNDING_BOX_SIZE_ERROR", MPFDetectionError::MPF_BOUNDING_BOX_SIZE_ERROR)
            .value("INVALID_FRAME_INTERVAL", MPFDetectionError::MPF_INVALID_FRAME_INTERVAL)
            .value("INVALID_START_FRAME", MPFDetectionError::MPF_INVALID_START_FRAME)
            .value("INVALID_STOP_FRAME", MPFDetectionError::MPF_INVALID_STOP_FRAME)
            .value("DETECTION_FAILED", MPFDetectionError::MPF_DETECTION_FAILED)
            .value("DETECTION_TRACKING_FAILED", MPFDetectionError::MPF_DETECTION_TRACKING_FAILED)
            ...
            .value("PROPERTY_IS_NOT_INT", MPFDetectionError::MPF_PROPERTY_IS_NOT_INT)
