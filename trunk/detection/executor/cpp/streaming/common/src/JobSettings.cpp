    ...
    JobSettings JobSettings::FromIniFile(const std::string &ini_path) {
        try {
            ...
            return {
                        ...
                        .frame_store_server_hostname = job_config.get<std::string>("frameStoreServerHostname"),
                        .frame_store_server_portnum = job_config.get<int>("frameStoreServerPortnum"),
                        ...
                        .frame_ready_queue = job_config.get<std::string>("frameReadyQueue"),
