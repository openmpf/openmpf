    ...
    JobSettings JobSettings::FromIniFile(const std::string &ini_path) {
        try {
            ...
            return {
                        ...
                        .num_pipeline_stages = job_config.get<int>("numPipelineStages"),
                        .pipeline_stage_number = job_config.get<int>("pipelineStageNumber"),
                        ...
                        .segment_ready_queue_stage1 = job_config.get<std::string>("stage1SegmentReadyQueue"),
                        .segment_ready_queue_stage2 = job_config.get<std::string>("stage2SegmentReadyQueue"),
                        .frame_ready_queue_stage1 = job_config.get<std::string>("stage1FrameReadyQueue"),
                        .frame_ready_queue_stage2 = job_config.get<std::string>("stage2FrameReadyQueue"),
                        .release_frame_queue = job_config.get<std::string>("releaseFrameQueue"),
