...
if ((@ARGV) != 5) {
	...
	MPF::Jenkins::printFatal("perl $0 <mpf-path> <git-branch> <git-commit> <build-num> <json-package-path>\n");
...
MPF::Jenkins::printDebug("The JSON package path supplied as: $jsonPackagePath\n");

MPF::Jenkins::printDebug("Building MPF RPMs.\n");
MPF::Jenkins::mavenRPM($mpfPath, $gitBranch, $gitCommit, $buildNum, $jsonPackagePath);
