...
import org.mitre.mpf.rest.api.exceptions.TimeUtilsUsageException;
...
public class TimeUtils {
     ...
     * @throws TimeUtilsUsageException is thrown if the timestamp String is null. Throws DateTimeParseException if the timestamp String isn't parsable
     * using the date/time pattern adhered to by OpenMPF.
     */
    public static LocalDateTime parseStringAsLocalDateTime(String timestampStr) throws TimeUtilsUsageException, DateTimeParseException {
        if ( timestampStr == null ) {
            throw new TimeUtilsUsageException("Error, timestamp String may not be null");
        } else {
