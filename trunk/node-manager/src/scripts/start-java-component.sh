...
set -x
exec ${JAVA_HOME}/bin/java ${JAVA_FLAGS} -cp ${MPF_HOME}/jars/mpf-java-component-executor-6.0.jar:${MPF_HOME}/plugins/$3/$1 ${QUEUE_FLAGS} org.mitre.mpf.component.executor.detection.MPFDetectionMain $2
set +x
