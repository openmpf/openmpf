...
public class TestBoundingBox {
    ...
    public void testEquals() {
        BoundingBox box1 = new BoundingBox(12, 34, 56, 78, 0, false, 0, 0, 0, false, 0, Optional.empty());
        BoundingBox box2 = new BoundingBox(12, 34, 56, 78, 0, false, 0, 0, 0, false, 0, Optional.empty());
        // Differ only by color.
        BoundingBox box3 = new BoundingBox(12, 34, 56, 78, 0, false, 0, 0, 0xFF, false, 0, Optional.empty());
