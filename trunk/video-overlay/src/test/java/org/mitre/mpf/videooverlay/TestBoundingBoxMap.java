...
public class TestBoundingBoxMap {
    ...
    public void testPutOnFrame() {
        ...
        BoundingBox boundingBox = new BoundingBox(25, 30, 100, 100, 0, false, 0xFF, 0, 0, 0, Optional.empty());
        BoundingBox boundingBoxCopy = new BoundingBox(25, 30, 100, 100, 0, false, 0xFF, 0, 0, 0, Optional.empty());
    ...
    public void testPutOnFrameNegativeFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrame(-1, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0, Optional.empty()));
    }
    ...
    public void testPutOnFramesStartFrameGreaterThanStopFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(4, 3, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0, Optional.empty()));
    }
    ...
    public void testPutWithNullValueInList() {
        ...
        boxes.add(null);
        boxes.add(new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0, Optional.empty()));
        map.put(5, boxes);
    }
    ...
    public void testPutOnFramesWithNullStartFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(null, 15, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0, Optional.empty()));
    }

    @Test(expected =  IllegalArgumentException.class)
    public void testPutOnFramesWithNullStopFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(15, null, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0, Optional.empty()));
    }
    ...
    public void testPutOnFramesWithNegativeStartFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(-3, 15, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0, Optional.empty()));
    }
