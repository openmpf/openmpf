...
public class TestBoundingBoxMap {
    ...
    public void testPutOnFrame() {
        ...
        BoundingBox boundingBox = new BoundingBox(25, 30, 100, 100, 0, false, 0xFF, 0, 0, 0.0f, Optional.empty());
        BoundingBox boundingBoxCopy = new BoundingBox(25, 30, 100, 100, 0, false, 0xFF, 0, 0, 0.0f, Optional.empty());
    ...
    public void testPutOnFrameNegativeFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrame(-1, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0.0f, Optional.empty()));
    }
    ...
    public void testPutOnFramesStartFrameGreaterThanStopFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(4, 3, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0.0f, Optional.empty()));
    }
    ...
    public void testPutAll() {
        ...
        for(int i = 1; i <= 10; i += 2) {
            ...
            BoundingBox boundingBox = new BoundingBox(i, i, i, i, i, false, i, i, i, i, Optional.empty());
    ...
    public void testPutWithNullValueInList() {
        ...
        boxes.add(null);
        boxes.add(new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0.0f, Optional.empty()));
        map.put(5, boxes);
    }
    ...
    public void testPutOnFramesWithNullStartFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(null, 15, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0.0f, Optional.empty()));
    }

    @Test(expected =  IllegalArgumentException.class)
    public void testPutOnFramesWithNullStopFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(15, null, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0.0f, Optional.empty()));
    }
    ...
    public void testPutOnFramesWithNegativeStartFrame() {
        BoundingBoxMap map = new BoundingBoxMap();
        map.putOnFrames(-3, 15, new BoundingBox(0, 0, 0, 0, 0, false, 0, 0, 0, 0.0f, Optional.empty()));
    }
