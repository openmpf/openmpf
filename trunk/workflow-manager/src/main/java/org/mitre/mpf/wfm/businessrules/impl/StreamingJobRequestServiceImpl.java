...
//    }
    ...
    public synchronized void cancel(long jobId, boolean doCleanup) throws WfmProcessingException {
        ...
        if (streamingJobRequest == null) {
            throw new WfmProcessingException("A streaming job with the id " + jobId + " is not known to the system.");
        }
     ...
     * @exception WfmProcessingException may be thrown if the streaming job has been cancelled, but the jobs output
    ...
    public synchronized void cleanup(long jobId, String outputObjectDirPath) throws WfmProcessingException {
        try {
            ...
            if (outputObjectDirPath == null || outputObjectDirPath.isEmpty()) {
                ...
                throw new WfmProcessingException(warningMessage);
            }
            ...
            throw new WfmProcessingException(warningMessage, e);
        }
