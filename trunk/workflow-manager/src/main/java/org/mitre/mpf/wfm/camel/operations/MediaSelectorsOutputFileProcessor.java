...
@Component(MediaSelectorsOutputFileProcessor.REF)
public class MediaSelectorsOutputFileProcessor extends WfmProcessor {

    public static final String REF = "mediaSelectorsOutputFileProcessor";

    private static final Logger LOG = LoggerFactory.getLogger(
            MediaSelectorsOutputFileProcessor.class);
    ...
    @Inject
    MediaSelectorsOutputFileProcessor(
