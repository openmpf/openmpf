...
public class MpfConstants {
    public static final String
            ...
            DETECTION_NOT_INITIALIZED = "DETECTION_NOT_INITIALIZED",
            UNSUPPORTED_DATA_TYPE = "UNSUPPORTED_DATA_TYPE",
            COULD_NOT_OPEN_DATAFILE = "COULD_NOT_OPEN_DATAFILE",
            COULD_NOT_READ_DATAFILE = "COULD_NOT_READ_DATAFILE",
            FILE_WRITE_ERROR = "FILE_WRITE_ERROR",
            BAD_FRAME_SIZE = "BAD_FRAME_SIZE",
            DETECTION_FAILED = "DETECTION_FAILED",
            MISSING_PROPERTY = "MISSING_PROPERTY",
            INVALID_PROPERTY = "INVALID_PROPERTY",
            MEMORY_ALLOCATION_FAILED = "MEMORY_ALLOCATION_FAILED",
            UNRECOGNIZED_DETECTION_ERROR = "UNRECOGNIZED_DETECTION_ERROR",
            DEAD_LETTER = "DEAD_LETTER",
            GPU_ERROR = "GPU_ERROR",
            NETWORK_ERROR = "NETWORK_ERROR",
            COULD_NOT_OPEN_MEDIA = "COULD_NOT_OPEN_MEDIA",
            COULD_NOT_READ_MEDIA = "COULD_NOT_READ_MEDIA";
