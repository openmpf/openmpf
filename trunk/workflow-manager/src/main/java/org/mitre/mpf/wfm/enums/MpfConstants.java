...
public class MpfConstants {
    public static final String
            ...
            TIES_DB_S3_COPY_DISABLED = "TIES_DB_S3_COPY_DISABLED",
            TIES_DB_COPY_SRC_S3_ACCESS_KEY = "TIES_DB_COPY_SRC_S3_ACCESS_KEY",
            TIES_DB_COPY_SRC_S3_SECRET_KEY = "TIES_DB_COPY_SRC_S3_SECRET_KEY",
            TIES_DB_COPY_SRC_S3_SESSION_TOKEN = "TIES_DB_COPY_SRC_S3_SESSION_TOKEN",
            TIES_DB_COPY_SRC_S3_REGION = "TIES_DB_COPY_SRC_S3_REGION",
            TIES_DB_COPY_SRC_S3_USE_VIRTUAL_HOST = "TIES_DB_COPY_SRC_S3_USE_VIRTUAL_HOST",
            TIES_DB_COPY_SRC_S3_HOST = "TIES_DB_COPY_SRC_S3_HOST",
            TIES_DB_COPY_SRC_S3_UPLOAD_OBJECT_KEY_PREFIX = "TIES_DB_COPY_SRC_S3_UPLOAD_OBJECT_KEY_PREFIX",
