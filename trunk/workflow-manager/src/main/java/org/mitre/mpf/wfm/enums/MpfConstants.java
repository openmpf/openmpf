...
public class MpfConstants {
    public static final String
            ...
            IS_ANNOTATOR_PROPERTY = "IS_ANNOTATOR",
            SUPPRESS_TRACKS_PROPERTY = "SUPPRESS_TRACKS",
            ...
            TRIGGER = "TRIGGER",
            REMOTE_MEDIA_ADD_TOKEN = "REMOTE_MEDIA_ADD_TOKEN",
            CALLBACK_ADD_TOKEN = "CALLBACK_ADD_TOKEN",
            TIES_DB_ADD_TOKEN = "TIES_DB_ADD_TOKEN",
            S3_ADD_TOKEN = "S3_ADD_TOKEN",
            ROLL_UP_FILE = "ROLL_UP_FILE",
            SELECTED_CONTENT = "SELECTED_CONTENT",
            MEDIA_SELECTORS_DELIMETER = "MEDIA_SELECTORS_DELIMETER",
            MEDIA_SELECTORS_DUPLICATE_POLICY = "MEDIA_SELECTORS_DUPLICATE_POLICY",
            MEDIA_SELECTORS_NO_MATCHES_IS_ERROR = "MEDIA_SELECTORS_NO_MATCHES_IS_ERROR";
