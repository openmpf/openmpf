...
public class MpfEndpoints {
    public static final String
			...
			// TODO routes for streaming jobs are TBD
			STREAMING_JOB_REQUESTS_ENTRY_POINT = "jms:MPF.STREAMING_JOB_REQUESTS",
			STREAM_FRAME_READER_ENTRY_POINT = "jms:MPF.STREAM_FRAME_READER",
