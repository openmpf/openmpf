...
public class TopQualitySelectionService {
    ...
    private TopQualitySelectionService() {}
    ...
    public static double getQuality(Detection det, String qualityProperty) {
        try {
            ...
            String errMsg = "The quality selection property \"" + qualityProperty + "\" could not be converted to a double value: " + det.getDetectionProperties().get(prop);
