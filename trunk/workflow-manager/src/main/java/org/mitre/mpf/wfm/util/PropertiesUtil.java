...
public class PropertiesUtil {
	...
	private FileSystemResource getKnownNodesData() {
		return new FileSystemResource(mpfPropertiesConfig.getString("data.known.nodes.file"));
	}

	public WritableResource getKnownNodes() {
		FileSystemResource knownNodesData = getKnownNodesData();
