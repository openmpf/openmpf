...
public class TestPipelineController extends TestCase {
    ...
    public void setup() throws WfmProcessingException {
        ...
        AlgorithmDefinition def1 = new AlgorithmDefinition(
                ActionType.DETECTION, "TEST_DETECTION_ALG", "svc_name",
                "Test algorithm for detection.", true, false);
        ...
        pipelineService.saveAlgorithm(new AlgorithmDefinition(
                ActionType.MARKUP, "TEST_MARKUP_ALG", "svc_name","Test algorithm for markup.", true, false));
