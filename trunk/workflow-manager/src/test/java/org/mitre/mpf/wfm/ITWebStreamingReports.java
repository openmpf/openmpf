...
public class ITWebStreamingReports {
    ...
    private static final String TRACK_TYPE = "MOTION";
    ...
    public void testPostSummaryReportCallback() throws InterruptedException {
        ...
        Assert.assertTrue(summaryReportPostResponseForJob1.getTrackTypes().containsKey(TRACK_TYPE) ||
                summaryReportPostResponseForJob1.getTrackTypes().containsKey(JsonActionOutputObject.NO_TRACKS_TYPE));
        ...
        Assert.assertTrue(summaryReportPostResponseForJob2.getTrackTypes().containsKey(TRACK_TYPE) ||
                summaryReportPostResponseForJob2.getTrackTypes().containsKey(JsonActionOutputObject.NO_TRACKS_TYPE));
    }
