...
public class TestTrackMergingProcessor {
    ...
    private void generateAndRunMerge(String filePath, MediaType mediaType, String mimeType, String samplingInterval,
        ...
        */
        ...
        Track track1 = new Track(TEST_JOB_ID, mediaId, 0, 0, 0, 199, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection1a, detection1b), noProps, detection1a.getMediaOffsetFrame());
        ...
        Track track2 = new Track(TEST_JOB_ID, mediaId, 0, 0, 200, 399, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection2a, detection2b), noProps, detection2a.getMediaOffsetFrame());
        ...
        Track track3 = new Track(TEST_JOB_ID, mediaId, 0, 0, 470, 477, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection3a, detection3b), noProps, detection3a.getMediaOffsetFrame());
        ...
        Track track4 = new Track(TEST_JOB_ID, mediaId, 0, 0, 480, 599, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection4a, detection4b), noProps, detection4a.getMediaOffsetFrame());
        ...
        Track track5 = new Track(TEST_JOB_ID, mediaId, 0, 0, 600, 610, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection5a, detection5b), noProps, detection5a.getMediaOffsetFrame());
    ...
    public void testTrackLevelInfoRetainedAfterMerge() {
        ...
        Track track1 = new Track(123, 1, 1, 1, 1, 1,
         0, 0, 1, 0.25f, Collections.emptyList(), track1Props, 0);
        ...
        Track track2 = new Track(123, 1, 1, 1, 1, 1,
         0, 0, 1, 0.75f, Collections.emptyList(), track2Props, 0);

        Track merged = TrackMergingProcessor.merge(track1, track2, "FIRST", "CONFIDENCE");
