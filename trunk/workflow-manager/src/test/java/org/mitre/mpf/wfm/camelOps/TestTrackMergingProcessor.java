...
public class TestTrackMergingProcessor {
    ...
    private void generateAndRunMerge(String filePath, MediaType mediaType, String mimeType, String samplingInterval,
        ...
        */
        ...
        Track track1 = new Track(TEST_JOB_ID, mediaId, 0, 0, 0, 199, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection1a, detection1b), noProps, detection1a);
        ...
        Track track2 = new Track(TEST_JOB_ID, mediaId, 0, 0, 200, 399, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection2a, detection2b), noProps, detection2a);
        ...
        Track track3 = new Track(TEST_JOB_ID, mediaId, 0, 0, 470, 477, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection3a, detection3b), noProps, detection3a);
        ...
        Track track4 = new Track(TEST_JOB_ID, mediaId, 0, 0, 480, 599, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection4a, detection4b), noProps, detection4a);
        ...
        Track track5 = new Track(TEST_JOB_ID, mediaId, 0, 0, 600, 610, 0, 0, 0, 18f,
                                 ImmutableSortedSet.of(detection5a, detection5b), noProps, detection5a);
    ...
    public void testTrackLevelInfoRetainedAfterMerge() {
        ...
        Track track1 = new Track(123, 1, 1, 1, 1, 1, 0, 0, 1, 0.25f, Collections.emptyList(), track1Props, null);

        Map<String, String> track2Props = ImmutableSortedMap.of(
                "track2_only_prop", "track2_only_val",
                "same_value_prop", "same_value_val",
                "diff_value_prop", "diff_value_val2");
        Track track2 = new Track(123, 1, 1, 1, 1, 1, 0, 0, 1, 0.75f, Collections.emptyList(), track2Props, null);
